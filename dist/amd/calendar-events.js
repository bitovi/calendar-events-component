/*@bitovi/calendar-events@0.0.4#calendar-events*/
    ...
    module.exports = safeCustomElement('calendar-events', function () {
        ...
        showEvents: function (getPastAndFutureEvents) {
            ...
            var elements = events.map(function (event) {
                ...
                container.innerHTML = '<div class=\'event-header\'>' + '<div class=\'event-title\'><a></a></div>' + '<div class=\'event-group\'></div>' + '<div class=\'event-date\'></div>' + '<div class=\'event-location\'></div>' + '<div class=\'event-body\'></div>' + '</div>' + '<div class=\'event-footer\'><a>View Event</a></div>';
