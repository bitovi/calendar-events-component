# Contributing to calendar-events

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/bitovi/calendar-events) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork calendar-events, you can start by going to its [fork page](https://github.com/bitovi/calendar-events/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/calendar-events
```
